...
public class InvoiceConfigurationTransformerTest {
    ...
    public void testToEntity() {
        InvoiceConfigurationTypeDTO typeDTO = InvoiceConfigurationTypeDTO.builder()
                .invoiceConfigurationType("Standard")
                .serviceCode("SRV-001")
        ...
        assertEquals(typeDTO.getInvoiceConfigurationType(), entity.getInvoiceConfigurationType().getType(), "Type should match");
    ...
    public void testToModel() {
        ...
        assertEquals(type.getType(), model.getInvoiceConfigurationType().getInvoiceConfigurationType(), "Type should match");
